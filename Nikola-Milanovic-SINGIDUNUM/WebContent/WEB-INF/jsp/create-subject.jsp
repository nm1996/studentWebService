...
<body>
	...
	<div class="container">
		<div class="row">
			<form
				action="${pageContext.request.contextPath}/subjects/do-create-subject"
				method="post">
				Name: <input class="form-control" type="text" name="name" /> <br />
				Description: <input class="form-control" type="text"
					name="description" /> <br /> Year of study: <select
					class="form-control" name="yearOfStudy">
					<option value="1">1</option>
					<option value="2">2</option>
					<option value="3">3</option>
					<option value="4">4</option>
				</select> <br /> <br /> Semester: <select class="form-control"
					name="semestar">
