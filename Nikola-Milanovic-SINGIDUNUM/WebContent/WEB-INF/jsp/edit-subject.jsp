...
<body>
	...
	<div class="container">
		<div class="row">
			<form
				action="${pageContext.request.contextPath}/subjects/do-edit-subject"
				method="post">
				<input type="hidden" name="subjectId" value="${subject.subjectId}" />
				Name: <input class="form-control" type="text" name="name"
					value="${subject.name}" /> <br /> Description: <input
					class="form-control" type="text" name="description"
					value="${subject.description}" /> <br /> Year of study: <select
					class="form-control" name="yearOfStudy">
					<option value="1">1</option>
					<option value="2">2</option>
					<option value="3">3</option>
					<option value="4">4</option>
				</select> <br /> Semester: <select class="form-control" name="semestar">
