...
<body>
	...
	<div class="container">
		<div class="row">
			<form action="${pageContext.request.contextPath}/cities/do-edit-city"
				method="post">
				<input class="form-control" type="hidden" name="cityId"
					value="${city.cityId }" /> Name: <input class="form-control"
					type="text" name="name" value="${city.name}" /> <br /> <input
					class="form-control" type="submit" value="Edit city" />
			</form>
