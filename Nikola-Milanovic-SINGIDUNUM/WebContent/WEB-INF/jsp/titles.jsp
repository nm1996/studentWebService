...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<table class="table" border="1px solid black">
				...
				<c:forEach var="title" items="${titles}">
					<tr>
						...
						<td><a
							href="${pageContext.request.contextPath }/titles/edit-title/${title.titleId}">Edit
								title</a></td>
						<td><a onclick="return test()"
							href="${pageContext.request.contextPath }/titles/delete-title/${title.titleId}">Delete</a></td>
					</tr>
				</c:forEach>
			</table>
			...
			<br /> <a
				href="${pageContext.request.contextPath }/titles/create-title">Create
				title</a><br /> <a href="${pageContext.request.contextPath }/">Back
				to index</a>
		</div>
	</div>
	<script>
