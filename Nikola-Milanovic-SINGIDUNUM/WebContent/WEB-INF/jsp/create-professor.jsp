...
<body>
	...
	<div class="container">
		<div class="row">
			<form
				action="${pageContext.request.contextPath}/professors/do-create-professor"
				method="post">
				...
				Reelectiondate: <input class="form-control" type="date"
					name="reelectiondate" /> <br /> City: <select class="form-control"
					name="city.cityId">
