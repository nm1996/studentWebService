...
<body>
	...
	<div class="container">
		<div class="row">
			<form
				action="${pageContext.request.contextPath}/students/do-edit-student"
				method="post">
				<input type="hidden" name="studentId" value="${student.studentId}" />
				FirstName: <input class="form-control" type="text" name="firstName"
					value="${student.firstName }" /> <br /> LastName: <input
					class="form-control" type="text" name="lastName"
					value="${student.lastName} " /> <br /> Email: <input
					class="form-control" type="email" name="email"
					value="${student.email} " /> <br /> Phone: <input
					class="form-control" type="text" name="phone"
					value="${student.phone} " /> <br /> Address: <input
					class="form-control" type="text" name="address"
					value="${student.address} " /> <br /> CurrentYearOfStudy: <select
					class="form-control" name="currentYearOfStudy">
					<option value="1">1</option>
					<option value="2">2</option>
					<option value="3">3</option>
					<option value="4">4</option>
				</select> <br /> Index: <input class="form-control" type="text"
					name="indexNumber" value="${student.indexNumber }" /> <br /> City:
				<select class="form-control" name="city.cityId">
